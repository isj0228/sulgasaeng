    ...
    <div class="card-body">
      ...
      <div class="text-center">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div
            class="progress progress-lg flex-grow-1 mb-3"
            style="height: 10px"
          >
            <div
        ...
        <button
          v-show="showButton"
          class="btn btn-primary btn-sm position-absolute top-0 end-0 mt-2 me-2"
        ...
        <div v-if="showInputField" class="input-group mb-3">
          <input
            type="number"
            class="form-control"
            v-model="targetExpenses"
            @change="updateTargetExpenses"
            placeholder="목표 소비 금액"
            aria-label="목표 소비 금액"
